<?php
    ...
    $stm = $_DB->prepare("UPDATE adaptive_answer_data SET answer = :answer, ans_check = :chk WHERE uid = :uid AND question = :question AND subject = :subject AND examination = :exam AND session = :session");
