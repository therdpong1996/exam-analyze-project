    ...
    <div class="container mt--8 pb-5">
        ...
        <div class="col-lg-6 col-md-8">
            ...
            <div class="card-body px-lg-5 py-lg-5">
                <form role="form" action="javascript:void(0)" id="teacher-register-form">
                <input type="hidden" name="token" value="<?php __($_GET['token']) ;?>">
                ...
                <input id="stu_id" name="student_id" value="none" type="hidden">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" readonly id="email" name="email" type="email" value="<?php __($email); ?>">
                    </div>
                </div>
                <div class="row my-4">
                <div class="col-12">
