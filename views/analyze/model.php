                                ...
                                <form action="javascript:void(0)" id="train-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <ul>
                                                <li><strong>เลือกข้อมูลทั้งหมดในคลังข้อสอบ</strong> คือ นำข้อมูลการสอบทั้งหมดที่ผ่านมาของข้อสอบชุด "" และทุกเซสชั่น(รวมถึงเซสชั่นนี้) เพื่อนำมาวิเคราะร์ข้อมูล</li>
                                                ...
                                                <li><strong>เลือกข้อมูลทั้งหมดในคลังข้อสอบ</strong> คือ นำข้อมูลการสอบทั้งหมดที่ของเซสชั่นนี้ เพื่อนำมาวิเคราะร์ข้อมูล</li>
                                            </ul>
