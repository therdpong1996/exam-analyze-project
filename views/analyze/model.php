<div class="col-xl-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-3"><button id="hide-all" class="mt-3 btn btn-primary btn-lg">Hide All</button></div>
                        <div class="col-3"><button id="show-all" class="mt-3 btn btn-info btn-lg">Show All</button></div>
                        <div class="col-6">
