    ...
    <div class="container-fluid pb-5 pt-5 pt-md-8">
        ...
        <div class="col-xl-1">
            ...
            <?php
                ...
                $stm = $_DB->prepare('SELECT answer FROM answer_data WHERE uid = :uid AND question = :question AND subject = :subject AND examination = :exam AND session = :session LIMIT 1');
                $stm->bindParam(':uid', $user_row['uid'], PDO::PARAM_INT);
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    $stm = $_DB->prepare('SELECT id FROM answer_data WHERE uid = :uid AND question = :question AND subject = :subject AND examination = :exam AND session = :session LIMIT 1');
                    $stm->bindParam(':uid', $user_row['uid'], PDO::PARAM_INT);
