...
<div class="main-content">
    ...
    <nav class="navbar bg-gradient-primary navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        ...
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Under construction</a>
                ...
                <div class="col-xl-12">
                    <div class="card shadow">
                        <div class="card-body text-center">
                            <i class="fas fa-cog fa-spin fa-10x mb-3"></i>
                            <h1>This page under construction</h1>
                            <p class="text-muted">หน้านี้กำลังอยู่ในช่วงของการปรับปรุง</p>
                        </div>
                    </div>
                </div>
            </div>
