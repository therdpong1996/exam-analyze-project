                        ...
                        <div class="card-body">
                            <form action="javascript:void(0)" id="setting-form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_regis" name="init_regis" value="1" <?php __($_GS['init_regis']==1?'checked':''); ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_article" name="init_article" value="1" <?php __($_GS['init_article']==1?'checked':''); ?>>
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_subject" name="init_subject" value="1" <?php __($_GS['init_subject']==1?'checked':''); ?>>
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_exam" name="init_exam" value="1" <?php __($_GS['init_exam']==1?'checked':''); ?>>
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_session" name="init_session" value="1" <?php __($_GS['init_session']==1?'checked':''); ?>>
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_testing" name="init_testing" value="1" <?php __($_GS['init_testing']==1?'checked':''); ?>>
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                ...
                                <hr>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="init_graph">ระบบ train data and  graph</label>
                                    <div class="col-sm-10">
                                        <label class="custom-toggle">
                                            <input type="checkbox" id="init_graph" name="init_graph" value="1" <?php __($_GS['init_graph']==1?'checked':''); ?>>
                                            <span class="custom-toggle-slider rounded-circle"></span>
                                        </label>
                                        <small class="text-muted">เปิด-ปิด ระบบการทดสอบของนักศึกษา</small>
                                    </div>
